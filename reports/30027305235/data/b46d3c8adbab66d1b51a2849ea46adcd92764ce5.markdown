...
Call log:
  ...
  - waiting for locator('#api-reference')
    59 × locator resolved to <div data-v-app="" id="api-reference" class="api-reference min-h-[42rem] overflow-hidden rounded-lg border border-border bg-background">…</div>
