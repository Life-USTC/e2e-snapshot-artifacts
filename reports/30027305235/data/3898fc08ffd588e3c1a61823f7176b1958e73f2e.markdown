...
+   "locale": "zh-cn",
+   "fetchedAt": "2026-07-23T17:04:11.064Z",
+   "version": {
+     "id": -9007199254740991,
+     "key": "string",
+     "title": "string",
+     "effectiveFrom": null,
+     "effectiveUntil": null,
+     "importedAt": "2026-07-23T17:04:11.064Z",
+     "notice": {
+       "message": null,
+       "url": null
+     }
...
+     "nameSecondary": null
+   },
+   "atTime": "2026-07-23T17:04:11.064Z",
+   "dayType": "weekday",
+   "totalRoutes": 0,
+   "departures": [
+     {
...
AuthenticationSelect Auth Type  No authentication selected "
    55 × locator resolved to <div data-v-app="" id="api-reference" class="api-reference min-h-[42rem] overflow-hidden rounded-lg border border-border bg-background">…</div>
       - unexpected value "v1.0.0OpenAPI 3.0.0catalog.bus
OpenAPI document generated from SvelteKit route handlers
 Server Server:http://localhost:3000
Current origin
