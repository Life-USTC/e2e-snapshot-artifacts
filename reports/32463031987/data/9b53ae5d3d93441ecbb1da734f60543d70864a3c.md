...
- Name: src/app/dashboard/exams/test.ts >> 仪表盘考试 >> 已完成筛选显示过往考试，未完成显示即将到来
- Location: tests/e2e/src/app/dashboard/exams/test.ts:207:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fexams
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fexams", waiting until "domcontentloaded"
