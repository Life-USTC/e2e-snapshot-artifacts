...
- Name: src/app/dashboard/comments/test.ts >> 仪表盘无效标签（comments） >> /workspace/comments 不是仪表盘路由页面
- Location: tests/e2e/src/app/dashboard/comments/test.ts:28:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/workspace/comments
Call log:
  - navigating to "http://localhost:3000/workspace/comments", waiting until "domcontentloaded"
