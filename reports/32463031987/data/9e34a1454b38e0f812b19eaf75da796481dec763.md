...
- Name: src/app/guides/markdown-support/test.ts >> /guides/markdown-support Markdown 支持页 >> KaTeX Size3 字体在 CSP 下可加载
- Location: tests/e2e/src/app/guides/markdown-support/test.ts:36:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/guides/markdown-support
Call log:
  - navigating to "http://localhost:3000/guides/markdown-support", waiting until "load"
