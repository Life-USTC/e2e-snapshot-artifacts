...
- Name: src/app/dashboard/comments/test.ts >> 仪表盘无效标签（comments） >> 未登录 ?tab=comments 保持轻量公共首页
- Location: tests/e2e/src/app/dashboard/comments/test.ts:38:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/?tab=comments
Call log:
  - navigating to "http://localhost:3000/?tab=comments", waiting until "domcontentloaded"
