...
- Name: src/app/dashboard/calendar/test.ts >> 仪表盘日历 >> 登录后显示日历，包含班级事件链接和星期标签
- Location: tests/e2e/src/app/dashboard/calendar/test.ts:59:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fcalendar
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fcalendar", waiting until "domcontentloaded"
