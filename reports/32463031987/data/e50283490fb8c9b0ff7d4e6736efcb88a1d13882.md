...
- Name: src/app/dashboard/test.ts >> 仪表盘 >> 无效 tab 不再选择其他公共资源
- Location: tests/e2e/src/app/dashboard/test.ts:47:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/?tab=unknown
Call log:
  - navigating to "http://localhost:3000/?tab=unknown", waiting until "domcontentloaded"
