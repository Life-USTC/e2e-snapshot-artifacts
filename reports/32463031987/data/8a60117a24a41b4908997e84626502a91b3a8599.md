...
- Location: tests/e2e/src/app/dashboard/test.ts:205:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Flinks
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Flinks", waiting until "domcontentloaded"
