...
- Name: src/app/dashboard/comments/test.ts >> 仪表盘无效标签（comments） >> 登录后 ?tab=comments 回退到总览
- Location: tests/e2e/src/app/dashboard/comments/test.ts:59:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2F%3Ftab%3Dcomments
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2F%3Ftab%3Dcomments", waiting until "domcontentloaded"
