...
- Name: src/app/global-search/test.ts >> signed-in global search returns catalog results
- Location: tests/e2e/src/app/global-search/test.ts:123:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Foverview
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Foverview", waiting until "domcontentloaded"
