...
- Name: src/app/dashboard/subscriptions/sections/test.ts >> 仪表盘教学班订阅 >> 旧版 /dashboard/subscriptions/sections 重定向到教学班订阅页面
- Location: tests/e2e/src/app/dashboard/subscriptions/sections/test.ts:71:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fsubscriptions
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Fsubscriptions", waiting until "domcontentloaded"
