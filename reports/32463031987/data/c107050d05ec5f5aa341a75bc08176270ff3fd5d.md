...
- Name: src/app/e2e/oauth/callback/test.ts >> /e2e/oauth/callback 回调页 >> 页面契约
- Location: tests/e2e/src/app/e2e/oauth/callback/test.ts:9:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/e2e/oauth/callback?code=e2e-test-code&state=e2e-test-state
Call log:
  - navigating to "http://localhost:3000/e2e/oauth/callback?code=e2e-test-code&state=e2e-test-state", waiting until "domcontentloaded"
