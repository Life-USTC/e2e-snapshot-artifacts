...
- Name: src/app/dashboard/todos/test.ts >> 仪表盘待办 >> 嵌套待办路由渲染服务端操作错误
- Location: tests/e2e/src/app/dashboard/todos/test.ts:180:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Ftodos
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fworkspace%2Ftodos", waiting until "domcontentloaded"
