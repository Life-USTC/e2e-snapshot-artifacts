...
- Location: tests/e2e/src/app/oauth/authorize/test.ts:232:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/oauth/authorize
Call log:
  - navigating to "http://localhost:3000/oauth/authorize", waiting until "domcontentloaded"
