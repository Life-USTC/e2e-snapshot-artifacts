...
- Name: src/app/sections/[jwId]/test.ts >> 页面契约
- Location: tests/e2e/src/app/sections/[jwId]/test.ts:1695:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/catalog/sections/9902001/introduction
Call log:
  - navigating to "http://localhost:3000/catalog/sections/9902001/introduction", waiting until "domcontentloaded"
