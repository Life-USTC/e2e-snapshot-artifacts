...
- Name: src/app/settings/danger/test.ts >> /account/settings/danger 危险区设置 >> 实际删除账号后退出登录并可重新登录
- Location: tests/e2e/src/app/settings/danger/test.ts:98:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fdanger
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fdanger", waiting until "domcontentloaded"
