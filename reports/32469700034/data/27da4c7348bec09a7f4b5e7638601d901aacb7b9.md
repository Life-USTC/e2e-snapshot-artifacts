...
- Name: src/app/sections/[jwId]/test.ts >> /catalog/sections/[jwId] 班级详情页 >> 班级作业区块默认以列表展示
- Location: tests/e2e/src/app/sections/[jwId]/test.ts:1046:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/catalog/sections/9902001
Call log:
  - navigating to "http://localhost:3000/catalog/sections/9902001", waiting until "domcontentloaded"
