...
- Name: src/app/sections/[jwId]/test.ts >> /catalog/sections/[jwId] 班级详情页 >> 已登录用户可创建作业、查看讨论、切换完成状态并删除
- Location: tests/e2e/src/app/sections/[jwId]/test.ts:1055:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Fsections%2F9902001
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Fsections%2F9902001", waiting until "domcontentloaded"
