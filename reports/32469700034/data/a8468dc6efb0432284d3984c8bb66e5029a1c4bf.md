...
- Name: src/app/sections/test.ts >> /catalog/sections 班级搜索页 >> 页面契约
- Location: tests/e2e/src/app/sections/test.ts:44:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/catalog/sections?search=IS3003.01
Call log:
  - navigating to "http://localhost:3000/catalog/sections?search=IS3003.01", waiting until "domcontentloaded"
