...
- Name: src/app/settings/passkeys/test.ts >> /account/settings/accounts 通行密钥 >> 注册、退出、通行密钥登录、重命名和删除
- Location: tests/e2e/src/app/settings/passkeys/test.ts:13:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Faccounts
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Faccounts", waiting until "domcontentloaded"
