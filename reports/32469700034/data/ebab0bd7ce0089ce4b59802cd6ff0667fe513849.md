...
- Name: src/app/sections/[jwId]/test.ts >> /catalog/sections/[jwId] 班级详情页 >> 评论可上传附件并通过签名下载链接打开
- Location: tests/e2e/src/app/sections/[jwId]/test.ts:1559:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2F
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2F", waiting until "domcontentloaded"
