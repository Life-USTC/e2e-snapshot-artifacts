...
- Name: src/app/settings/profile/test.ts >> /account/settings/profile 个人资料设置 >> 需要登录
- Location: tests/e2e/src/app/settings/profile/test.ts:36:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/profile
Call log:
  - navigating to "http://localhost:3000/account/settings/profile", waiting until "domcontentloaded"
