...
- Name: src/app/settings/security/test.ts >> /account/settings/security 安全活动 >> 需要登录
- Location: tests/e2e/src/app/settings/security/test.ts:17:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/security
Call log:
  - navigating to "http://localhost:3000/account/settings/security", waiting until "domcontentloaded"
