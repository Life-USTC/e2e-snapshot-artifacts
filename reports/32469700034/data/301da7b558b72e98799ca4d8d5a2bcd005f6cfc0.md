...
- Name: src/app/settings/danger/test.ts >> /account/settings/danger 危险区设置 >> 需要登录
- Location: tests/e2e/src/app/settings/danger/test.ts:36:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/danger
Call log:
  - navigating to "http://localhost:3000/account/settings/danger", waiting until "domcontentloaded"
