...
- Location: tests/e2e/src/app/signin/test.ts:90:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in
Call log:
  - navigating to "http://localhost:3000/account/sign-in", waiting until "domcontentloaded"
