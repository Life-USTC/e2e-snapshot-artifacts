...
- Name: src/app/sections/test.ts >> /catalog/sections 班级搜索页 >> 学期筛选保留种子数据结果
- Location: tests/e2e/src/app/sections/test.ts:572:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/catalog/sections?semesterId=1
Call log:
  - navigating to "http://localhost:3000/catalog/sections?semesterId=1", waiting until "domcontentloaded"
