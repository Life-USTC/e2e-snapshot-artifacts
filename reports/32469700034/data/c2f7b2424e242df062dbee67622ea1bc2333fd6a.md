...
- Name: src/app/settings/content/test.ts >> /account/settings/content legacy redirect >> direct /account/settings/content path returns 404
- Location: tests/e2e/src/app/settings/content/test.ts:23:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fprofile
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fprofile", waiting until "domcontentloaded"
