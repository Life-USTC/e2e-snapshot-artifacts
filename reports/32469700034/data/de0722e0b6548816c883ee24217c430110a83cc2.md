...
- Name: src/app/settings/preferences/test.ts >> /account/settings/preferences 外观与语言偏好 >> 外观选择立即应用并写入既有 localStorage
- Location: tests/e2e/src/app/settings/preferences/test.ts:34:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fpreferences
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Faccount%2Fsettings%2Fpreferences", waiting until "domcontentloaded"
