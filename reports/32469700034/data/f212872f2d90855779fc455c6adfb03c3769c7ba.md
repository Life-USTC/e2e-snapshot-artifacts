...
- Location: tests/e2e/src/app/signin/test.ts:122:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fsections
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fsections", waiting until "domcontentloaded"
