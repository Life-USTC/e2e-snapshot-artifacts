...
- Name: src/app/settings/preferences/test.ts >> /account/settings/preferences 外观与语言偏好 >> legacy query 输入规范到语义路径
- Location: tests/e2e/src/app/settings/preferences/test.ts:20:3
