...
- Name: src/app/settings/accounts/test.ts >> /account/settings/accounts 关联账号设置 >> 需要登录
- Location: tests/e2e/src/app/settings/accounts/test.ts:45:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/accounts
Call log:
  - navigating to "http://localhost:3000/account/settings/accounts", waiting until "domcontentloaded"
