...
- Name: src/app/settings/authorizations/test.ts >> /account/settings/authorizations OAuth 授权 >> 需要登录
- Location: tests/e2e/src/app/settings/authorizations/test.ts:18:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/authorizations
Call log:
  - navigating to "http://localhost:3000/account/settings/authorizations", waiting until "domcontentloaded"
