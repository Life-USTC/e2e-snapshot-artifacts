...
- Name: src/app/sections/[jwId]/test.ts >> /catalog/sections/[jwId] 班级详情页 >> 已登录用户可编辑班级简介
- Location: tests/e2e/src/app/sections/[jwId]/test.ts:892:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Fsections%2F9902001%23introduction
Call log:
  - navigating to "http://localhost:3000/account/sign-in?callbackUrl=%2Fcatalog%2Fsections%2F9902001%23introduction", waiting until "domcontentloaded"
