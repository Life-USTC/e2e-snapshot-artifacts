...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings
Call log:
  - navigating to "http://localhost:3000/account/settings", waiting until "domcontentloaded"
