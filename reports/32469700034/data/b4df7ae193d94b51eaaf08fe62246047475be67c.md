...
- Name: src/app/sections/test.ts >> /catalog/sections 班级搜索页 >> 无匹配班级时显示明确空状态且不渲染结果链接
- Location: tests/e2e/src/app/sections/test.ts:51:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/catalog/sections?search=e2e-no-matching-section-7f3c9a
Call log:
  - navigating to "http://localhost:3000/catalog/sections?search=e2e-no-matching-section-7f3c9a", waiting until "domcontentloaded"
