...
- Name: src/app/settings/preferences/test.ts >> /account/settings/preferences 外观与语言偏好 >> canonical 路径需要登录
- Location: tests/e2e/src/app/settings/preferences/test.ts:11:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/account/settings/preferences
Call log:
  - navigating to "http://localhost:3000/account/settings/preferences", waiting until "domcontentloaded"
